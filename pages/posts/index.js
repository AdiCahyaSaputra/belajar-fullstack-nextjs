			...
			{posts.map(post => {
				return (
					...
					<div key={post.id} className="border border-gray-100 my-2 p-4 bg-white shadow-md rounded-md">
						...
						<div className="ml-2 py-1 rounded-md hover:bg-blue-700 px-3 text-sm inline-block font-medium mt-2 bg-blue-600 text-white"
							onClick={() => Router.push(`/posts/detail/${post.id}`)}
						>
							&rarr;
						</div>
					</div>
